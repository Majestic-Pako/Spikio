...
export default function CoreKeeper() {
    ...
    const handleStarHover = (value) => setHoverValue(value);
    const handleStarLeave = () => setHoverValue(0);
    const handleStarClick = (value) => setRatingValue(value);
    ...
    return (
        <>
            <div className="parallax parallax-core">
                <div className="overlay"></div>
                <div className="info">
                    <div className="foto">
                        <img src="/img/core.png" alt="Core Keeper" />
                    </div>
                    <div className="info-text">
                        ...
                        <div className="info-box">
                            <div className="casilla sinopsis">
                                <h3>Sinopsis</h3>
                                <p>Core Keeper es un juego de supervivencia y crafteo subterráneo para 1-8 jugadores. 
                                    Explora una antigua caverna de recursos, tesoros y peligros mientras luchas contra 
                                    monstruos, cultivas cultivos, fabricas artículos y descubres secretos en este mundo generado de forma procedural.
                                </p>
                            </div>
                            <div className="casilla">
                                <strong>Desarrollador:</strong> Pugstorm
                            </div>
                            <div className="casilla">
                                <strong>Editor:</strong> Fireshine Games
                            </div>
                            <div className="casilla">
                                <strong>Fecha de Lanzamiento:</strong> 8 MARZO 2022
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="sitios">
                ...
                <a href="https://store.steampowered.com/app/1621690/Core_Keeper/" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="card-sitio">
                    <i className="fa-brands fa-steam"></i>
                    <p>Steam</p>
                </a>
                <a href="https://store.playstation.com/es-ar/concept/10009534" target="_blank" className="card-sitio" rel="noreferrer">
                    <i className="fa-brands fa-playstation"></i>
                    <p>Playstation</p>
                </a>
                <a href="https://www.xbox.com/es-AR/games/store/core-keeper/9PKW4GMX4J8K" target="_blank" className="card-sitio" rel="noreferrer">
